...
# calling plt to create a Scatter plot for the average of all the three type of Iris flowers

plt.scatter(xsl, xsw, marker="o", color=['red','blue'], label = 'Sepal Data')
plt.scatter(ypl, ypw, marker="*", color=['orange','yellow'], label = 'Petal Data')
